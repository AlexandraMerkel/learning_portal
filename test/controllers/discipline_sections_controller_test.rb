...
class DisciplineSectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discipline_section" do
    assert_difference('DisciplineSection.count') do
      post discipline_sections_url, params: { discipline_section: { attenuation_constant: @discipline_section.attenuation_constant, community_id: @discipline_section.community_id, discipline_id: @discipline_section.discipline_id, discipline_type: @discipline_section.discipline_type, limit_time: @discipline_section.limit_time, max_score: @discipline_section.max_score, min_score: @discipline_section.min_score, optimal_time: @discipline_section.optimal_time, require_type: @discipline_section.require_type, section_name: @discipline_section.section_name, section_type: @discipline_section.section_type, weight: @discipline_section.weight } }
    end
  ...
  test "should update discipline_section" do
    patch discipline_section_url(@discipline_section), params: { discipline_section: { attenuation_constant: @discipline_section.attenuation_constant, community_id: @discipline_section.community_id, discipline_id: @discipline_section.discipline_id, discipline_type: @discipline_section.discipline_type, limit_time: @discipline_section.limit_time, max_score: @discipline_section.max_score, min_score: @discipline_section.min_score, optimal_time: @discipline_section.optimal_time, require_type: @discipline_section.require_type, section_name: @discipline_section.section_name, section_type: @discipline_section.section_type, weight: @discipline_section.weight } }
