...
class TermsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create term" do
    assert_difference('Term.count') do
      post terms_url, params: { term: { actual: @term.actual, term_end: @term.term_end, term_name: @term.term_name, term_start: @term.term_start } }
    end
  ...
  test "should update term" do
    patch term_url(@term), params: { term: { actual: @term.actual, term_end: @term.term_end, term_name: @term.term_name, term_start: @term.term_start } }
