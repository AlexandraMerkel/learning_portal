...
class DisciplinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discipline" do
    assert_difference('Discipline.count') do
      post disciplines_url, params: { discipline: { discipline_end: @discipline.discipline_end, discipline_name: @discipline.discipline_name, discipline_type: @discipline.discipline_type, ranking_algorithm_id: @discipline.ranking_algorithm_id, term_id: @discipline.term_id } }
    end
  ...
  test "should update discipline" do
    patch discipline_url(@discipline), params: { discipline: { discipline_end: @discipline.discipline_end, discipline_name: @discipline.discipline_name, discipline_type: @discipline.discipline_type, ranking_algorithm_id: @discipline.ranking_algorithm_id, term_id: @discipline.term_id } }
