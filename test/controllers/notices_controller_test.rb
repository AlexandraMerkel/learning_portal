...
class NoticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post notices_url, params: { notice: { community_section_id: @notice.community_section_id, notice_type: @notice.notice_type, user_id: @notice.user_id } }
    end
  ...
  test "should update notice" do
    patch notice_url(@notice), params: { notice: { community_section_id: @notice.community_section_id, notice_type: @notice.notice_type, user_id: @notice.user_id } }
